...
public class Game extends Thread {
	...
	public void screenDraw(Graphics2D g) {
		...
		if(comboCnt != 0) {
			...
			}else if(comboCnt >= 50 && comboCnt < 100) {
				g.setColor(Color.orange);
			}else if(comboCnt >= 100) {
				g.setColor(Color.red);
			}
			g.drawString(Integer.toString(comboCnt) + " HIT", 590, 400);
		}
		
		if(comboCnt != 0) {
			g.drawImage(blueFlareImage, 214, 274, null);
		}
	...
	public void dropNotes(String titleName) {
		Beat[] beats = null;
		if (titleName.equals("Joakim Karud - Love Mode") && difficulty.equals("Easy")) {
			int startTime = 5481 - Main.REACH_TIME * 1000;
			
			beats = loveModeBeat(beats, startTime);

		}else if(titleName.equals("Joakim Karud - Love Mode") && difficulty.equals("Hard")) {
			int startTime = 1000 - Main.REACH_TIME * 1000;
			
			beats = new Beat[] { new Beat(startTime, "Space")};
		}else if (titleName.equals("Bensound - SadDay") && difficulty.equals("Easy")) {
			int startTime = 1000 - Main.REACH_TIME * 1000;
			
			beats = new Beat[] { new Beat(startTime, "Space")};

		}else if (titleName.equals("Bensound - SadDay") && difficulty.equals("Hard")) {
			int startTime = 1000 - Main.REACH_TIME * 1000;
			
			beats = new Beat[] { new Beat(startTime, "Space")};

		}else if (titleName.equals("Alan Walker - Energy") && difficulty.equals("Easy")) {
			int startTime = 1000 - Main.REACH_TIME * 1000;
			
			beats = new Beat[] { new Beat(startTime, "Space")};
			
		}else if (titleName.equals("Alan Walker - Energy") && difficulty.equals("Hard")) {
			int startTime = 1000 - Main.REACH_TIME * 1000;
	...
	public Beat[] loveModeBeat(Beat[] beats, int startTime) {
		...
		beats = new Beat[] { 
				...
				new Beat(startTime + gap * 731, "K"),
				new Beat(startTime + gap * 735, "J"),
				new Beat(startTime + gap * 739, "S"),
				new Beat(startTime + gap * 743, "L"),
				new Beat(startTime + gap * 747, "D"),
				new Beat(startTime + gap * 751, "K"),
				new Beat(startTime + gap * 755, "F"),
				new Beat(startTime + gap * 759, "J"),
				new Beat(startTime + gap * 763, "F"),
				new Beat(startTime + gap * 767, "J"),
				new Beat(startTime + gap * 771, "D"),
				new Beat(startTime + gap * 775, "K"),
				new Beat(startTime + gap * 779, "S"),
				new Beat(startTime + gap * 783, "L"),
				new Beat(startTime + gap * 787, "F"),
				new Beat(startTime + gap * 793, "J"),
				new Beat(startTime + gap * 797, "F"),
				new Beat(startTime + gap * 801, "J"),
				new Beat(startTime + gap * 805, "D"),
				new Beat(startTime + gap * 809, "K"),
				new Beat(startTime + gap * 813, "D"),
				new Beat(startTime + gap * 817, "K"),
				new Beat(startTime + gap * 821, "S"),
				new Beat(startTime + gap * 825, "L"),
				new Beat(startTime + gap * 829, "S"),
				new Beat(startTime + gap * 833, "L"),
				new Beat(startTime + gap * 837, "D"),
				new Beat(startTime + gap * 841, "F"),
				new Beat(startTime + gap * 845, "D"),
				new Beat(startTime + gap * 849, "S"),
				new Beat(startTime + gap * 853, "D"),
				new Beat(startTime + gap * 857, "F"),
				new Beat(startTime + gap * 861, "J"),
				new Beat(startTime + gap * 865, "K"),
				new Beat(startTime + gap * 869, "L"),
				new Beat(startTime + gap * 873, "K"),
				new Beat(startTime + gap * 877, "L"),
				new Beat(startTime + gap * 881, "K"),
				new Beat(startTime + gap * 885, "J"),
				new Beat(startTime + gap * 889, "K"),
				new Beat(startTime + gap * 893, "J"),
				new Beat(startTime + gap * 897, "K"),
				new Beat(startTime + gap * 901, "F"),
				new Beat(startTime + gap * 905, "D"),
				new Beat(startTime + gap * 909, "F"),
				new Beat(startTime + gap * 913, "D"),
				new Beat(startTime + gap * 917, "F"),
				new Beat(startTime + gap * 921, "D"),
				new Beat(startTime + gap * 925, "S"),
				new Beat(startTime + gap * 929, "L"),
				new Beat(startTime + gap * 933, "K"),
				new Beat(startTime + gap * 937, "J"),
				new Beat(startTime + gap * 941, "K"),
				new Beat(startTime + gap * 945, "L"),
				new Beat(startTime + gap * 949, "K"),
				new Beat(startTime + gap * 953, "J"),
				new Beat(startTime + gap * 957, "F"),
				new Beat(startTime + gap * 961, "D"),
				new Beat(startTime + gap * 965, "F"),
				new Beat(startTime + gap * 969, "D"),
				new Beat(startTime + gap * 973, "S"),
				new Beat(startTime + gap * 977, "D"),
				new Beat(startTime + gap * 981, "S"),
				new Beat(startTime + gap * 985, "D"),
				new Beat(startTime + gap * 989, "F"),
				new Beat(startTime + gap * 993, "F"),
				new Beat(startTime + gap * 997, "D"),
				new Beat(startTime + gap * 1001, "S"),
				new Beat(startTime + gap * 1005, "D"),
				new Beat(startTime + gap * 1009, "F"),
				new Beat(startTime + gap * 1013, "J"),
				new Beat(startTime + gap * 1017, "F"),
				new Beat(startTime + gap * 1021, "K"),
				new Beat(startTime + gap * 1025, "D"),
				new Beat(startTime + gap * 1029, "F"),
				new Beat(startTime + gap * 1033, "J"),
				new Beat(startTime + gap * 1037, "K"),
				new Beat(startTime + gap * 1041, "F"),
				...
				new Beat(startTime + gap * 1085, "J"),
				new Beat(startTime + gap * 1089, "K"),
				new Beat(startTime + gap * 1093, "L"),
				new Beat(startTime + gap * 1097, "K"),
				new Beat(startTime + gap * 1101, "F"),
				new Beat(startTime + gap * 1105, "D"),
				new Beat(startTime + gap * 1109, "S"),
				new Beat(startTime + gap * 1113, "J"),
				new Beat(startTime + gap * 1117, "F"),
				new Beat(startTime + gap * 1121, "D"),
				new Beat(startTime + gap * 1125, "L"),
				new Beat(startTime + gap * 1129, "S"),
				new Beat(startTime + gap * 1133, "K"),
				new Beat(startTime + gap * 1137, "F"),
				new Beat(startTime + gap * 1141, "J"),
				new Beat(startTime + gap * 1145, "F"),
				new Beat(startTime + gap * 1149, "D"),
				new Beat(startTime + gap * 1153, "J"),
				new Beat(startTime + gap * 1157, "K"),
				new Beat(startTime + gap * 1161, "D"),
				new Beat(startTime + gap * 1165, "F"),
				new Beat(startTime + gap * 1169, "F"),
				new Beat(startTime + gap * 1173, "D"),
				new Beat(startTime + gap * 1177, "S"),
				new Beat(startTime + gap * 1181, "D"),
				new Beat(startTime + gap * 1185, "F"),
				new Beat(startTime + gap * 1189, "J"),
				new Beat(startTime + gap * 1193, "K"),
				new Beat(startTime + gap * 1197, "J"),
				new Beat(startTime + gap * 1201, "K"),
				new Beat(startTime + gap * 1205, "L"),
				new Beat(startTime + gap * 1209, "K"),
				new Beat(startTime + gap * 1213, "L"),
				new Beat(startTime + gap * 1217, "K"),
				new Beat(startTime + gap * 1221, "J"),
				new Beat(startTime + gap * 1225, "J"),
				new Beat(startTime + gap * 1229, "K"),
				new Beat(startTime + gap * 1233, "J"),
				new Beat(startTime + gap * 1237, "K"),
				new Beat(startTime + gap * 1241, "F"),
				new Beat(startTime + gap * 1245, "D"),
				new Beat(startTime + gap * 1249, "S"),
				new Beat(startTime + gap * 1253, "F"),
				new Beat(startTime + gap * 1257, "J"),
				new Beat(startTime + gap * 1261, "K"),
				new Beat(startTime + gap * 1265, "J"),
				new Beat(startTime + gap * 1269, "K"),
				new Beat(startTime + gap * 1273, "L"),
				new Beat(startTime + gap * 1277, "L"),
				new Beat(startTime + gap * 1281, "S"),
				new Beat(startTime + gap * 1285, "D"),
				new Beat(startTime + gap * 1289, "F"),
				new Beat(startTime + gap * 1293, "F"),
				new Beat(startTime + gap * 1297, "J"),
				new Beat(startTime + gap * 1301, "K"),
				new Beat(startTime + gap * 1305, "J"),
				new Beat(startTime + gap * 1309, "F"),
				new Beat(startTime + gap * 1313, "D"),
				new Beat(startTime + gap * 1317, "S"),
				new Beat(startTime + gap * 1321, "D"),
				new Beat(startTime + gap * 1325, "S"),
				new Beat(startTime + gap * 1329, "J"),
				new Beat(startTime + gap * 1333, "D"),
				new Beat(startTime + gap * 1337, "K"),
				new Beat(startTime + gap * 1341, "D"),
				new Beat(startTime + gap * 1345, "J"),
				new Beat(startTime + gap * 1349, "F"),
				new Beat(startTime + gap * 1353, "K"),
				new Beat(startTime + gap * 1357, "D"),
				new Beat(startTime + gap * 1361, "L"),
				new Beat(startTime + gap * 1365, "S"),
				new Beat(startTime + gap * 1369, "D"),
				new Beat(startTime + gap * 1373, "D"),
				new Beat(startTime + gap * 1377, "J"),
				new Beat(startTime + gap * 1381, "D"),
				new Beat(startTime + gap * 1385, "F"),
				new Beat(startTime + gap * 1389, "J"),
...
//				new Beat(startTime + gap * 1401, "Space"),
	...
	public void judgeEvent(String judge) {
		...
		if(judge.equals("Miss")) {
			...
			score+=judgeScore(judge, comboCnt);
			comboCnt++;
	...
	public int judgeScore(String judge, int	comboCnt) {
		int plusScore = 0;
		
		if(judge.equals("Miss")) {
		}else if(judge.equals("Late")) {
			plusScore+=(100 + comboCnt * 10);
		}else if(judge.equals("Good")) {
			plusScore+=(300 + comboCnt * 30);
		}else if(judge.equals("Great")) {
			plusScore+=(500 + comboCnt * 50);
		}else if(judge.equals("Perfect")) {
			plusScore+=(1000 + comboCnt * 100);
		}else if(judge.equals("Early")) {
			plusScore+=(100 + comboCnt * 10);
		}
