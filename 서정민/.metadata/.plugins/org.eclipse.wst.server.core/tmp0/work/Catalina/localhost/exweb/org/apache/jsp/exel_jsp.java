 ...
 * Generated at: 2020-06-10 02:42:51 UTC
...
String s = "Hello, EL"; 
      ...
      out.write("\tx 파라미터값 :");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${param[\"x\"]}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("<br/> <!--변수값을 속성으로 사용할 경우 []사용 -->\t\r\n");
      ...
      out.write("<br/> \r\n");
      out.write("\t <!-- 변수명을으로 사용할수 없는 문자가 사용된경우 []로 사용 --> \r\n");
      out.write("\t<!-- JSP기본 객체(request,response,session,application)는 pageContext에 포함되어  있으므로 꺼내서 사용 -->\r\n");
      out.write("\t현재 웹애플리케이션 (프로젝트)고유경로(컨텍스트패스):");
