<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <form action='${pageContext.request.contextPath}/member/edit.do' method='post'> 
  	...
  	아이디: <input text='text' name='memId' value='${memVo.memId}' readonly /><br/>              
  	이름: <input text='text' name='memName'value='${memVo.memName}'/><br/>               
  	포인트: <input text='text' name='memPoint'value='${memVo.memPoint}'/><br/>          
