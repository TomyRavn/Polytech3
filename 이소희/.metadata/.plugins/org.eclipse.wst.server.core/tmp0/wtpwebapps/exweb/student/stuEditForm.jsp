...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <form action='<%=request.getContextPath()%>/student/stuEdit.do' method='post'> 
       ...
       <a href='<%=request.getContextPath()%>/student/stuDel.jsp?stu_no=<%=vo.getStuNo()%>'><button type='button'> 삭제 </button></a><br/>                                   
         		</form> 
